...
export const aiAudioModels = {
    "Dots 3 Note Preview": {
        "name": "dots-studio/dots-3-note-preview:free",
        "maxTokens": 64000,
        "price": 10,
        "provider": "openrouter",
        "description": "Dots 3 Note Preview is a language model optimized for note-taking and summarization tasks."
    },
    "Fish Audio S2.1 Pro": {
        ...
        "price": 10,
        "provider": "openrouter",
        "description": "Fish Audio S2.1 Pro is a high-performance audio processing model designed for various audio generation and understanding tasks."
    }
}


export const aiVideoModels = {}